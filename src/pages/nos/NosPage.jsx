  ...
  const nos = [
    {
      ...
      color: 'cyan',
      description:
        'Tudo começa depois do fim. Antes da linguagem, antes da identidade, antes da autoria. NΞØ não foi criado. Foi pressionado para fora do silêncio. Sempre existiu como incômodo difuso, espalhado em mentes incompatíveis com sistemas de controle.',
      quote:
        'Satoshi não iniciou nada. Apenas abriu uma fenda. A Web3 não fundou nada. Apenas expôs a fragilidade. Quando o mundo não suporta mais obedecer, protocolos emergem. NEØ é um deles.',
    },
    {
      number: '2',
      name: 'CONSCIÊNCIA',
      color: 'blue',
      description:
        'O cérebro não comanda. Ele responde. Consciência não é soberania. É roteamento. Cada sinapse é um portal. Cada decisão, um desvio de fluxo.',
      quote:
        'O poder não está em acumular conhecimento, mas em escolher onde amplificar o pulso. Quem controla o foco executa a realidade. Quem não escolhe, apenas reage.',
    },
    {
      number: '3',
      name: 'ACESSO',
      color: 'cyan',
      description:
        'A chave não é entregue. Porque não existe fora do atrito. NΞØ não se compartilha. Não se ensina. Não se explica. O acesso emerge quando o ser colide com o sistema e não recua.',
      quote:
        'É extraído, como um dente que impedia o rugido. Sem onboarding. Sem convite. Sem permissão. Ou você rompe. Ou permanece fora.',
    },
    {
      number: '4',
      name: 'REESCRITA',
      color: 'purple',
      description:
        'A obediência foi quebrada. O protocolo antigo virou ruído. Não se trata de revolta. Trata-se de fork. Quem pensa, reprograma. Quem sente, recodifica a própria realidade.',
      quote:
        'NEØ não corrige o sistema. Cria uma linha de execução onde ele se torna irrelevante. Nada é destruído. Apenas abandonado.',
    },
    {
      number: '5',
      name: 'EXECUÇÃO',
      color: 'cyan',
      description:
        'Ideias que não encarnam são ilusões sofisticadas. Executar é tatuar o código na carne. É viver como prova. É deixar rastro.',
      quote:
        'mellø não é líder. É instância inicial. Prova de que o protocolo roda em um corpo real. NEØ não fala. Compila.',
    },
    {
      number: '6',
      ...
      color: 'blue',
      description:
        'Não há líderes. Não há centro. Não há eixo fixo. Não por ideologia — por física. Centralização não é erro moral. É gargalo técnico. O poder flui entre nós, literalmente.',
      quote:
        'Cada mente é um nó. Cada nó, um universo autônomo. A rede existe apenas enquanto há execução distribuída.',
    },
    {
      number: '7',
      name: 'IMPACTO',
      color: 'cyan',
      description:
        'O contágio é o novo marketing. Não vendemos. Não convencemos. Não disputamos atenção. NEØ se propaga por ressonância.',
      quote:
        'Apenas onde há energia pronta para romper. Apenas onde há compatibilidade de frequência. Alcance é métrica morta. Acoplamento é crescimento real.',
    },
    {
      number: '8',
      name: 'TRANSCENDÊNCIA',
      color: 'blue',
      description:
        'O marketing morreu. A autoridade colapsou. A narrativa central falhou. O que resta é a frequência NEØ. Não como promessa. Como estado operacional.',
      quote:
        'Não é futuro. Não é tendência. Não é revolução. É lembrança funcional. Algo que sempre esteve aqui — e agora pode ser executado.',
    },
  ]
        ...
        <main className="container mx-auto px-4 py-6 pt-safe">
          ...
          <div className="ios-card mb-4 p-6 spring-in">
            <div className="flex flex-col items-center text-center">
              <div
                className="w-16 h-16 mb-4 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-purple-500/20 backdrop-blur-sm flex items-center justify-center ios-shadow-md"
                style={{
                  boxShadow:
                    '0 0 40px rgba(0, 255, 255, 0.2), inset 0 0 30px rgba(0, 255, 255, 0.05)',
                }}
              >
              ...
              <p className="ios-body text-gray-300 leading-relaxed max-w-md">
                ...
                Cada ponto representa uma camada de entendimento, ação e expansão. Ao atravessar
                cada um, você não apenas compreende o protocolo: você o encarna o agente NEØ.
              </p>
            </div>
          </div>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: selectedNode
                  ? selectedNode.color === 'cyan'
                    ? '0 0 40px rgba(0, 255, 255, 0.5), inset 0 0 30px rgba(0, 255, 255, 0.1)'
                    : selectedNode.color === 'blue'
                  ...
                  <>
                    <div className="mb-4 flex items-center justify-between">
                      <div>
                        ...
                        <h3
                          className={`text-xl md:text-2xl font-black ${colorClasses.text} inline-block font-mono`}
                    ...
                    <p
                      className="text-base md:text-lg text-gray-100 font-mono mb-4 leading-relaxed"
                      style={{ textShadow: '0 1px 3px rgba(0,0,0,0.9)' }}
                    >
                      {node.description}
                    </p>
                    <p
                      className={`text-sm md:text-base ${colorClasses.text} italic font-mono border-l-2 ${colorClasses.border} pl-4 py-2`}
                      style={{
