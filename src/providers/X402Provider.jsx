...
const serverWalletAddress =
  import.meta.env.VITE_X402_SERVER_WALLET_ADDRESS || '0x765B22a98F101a82c071D4C36980B51213B98d4C'
...
export const thirdwebX402Facilitator =
  secretKey && globalClient && serverWalletAddress
...
export default function X402Provider({ children }) {
  return (
    <ThirdwebClientContext.Provider value={globalClient}>{children}</ThirdwebClientContext.Provider>
  )
}
