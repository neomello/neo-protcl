...
const CACHE_NAME = 'neo-protocol-v3.0.0'
const RUNTIME_CACHE = 'neo-protocol-runtime-v3.0.0'
...
self.addEventListener('push', event => {
  ...
  event.waitUntil(self.registration.showNotification('NΞØ Protocol', options))
})
